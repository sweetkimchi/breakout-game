...
public class Levels {
   ...
   * data in files. Allows each separate game to load its own levels by calling the method. Populates
   * the root with appropriate sprites as indicated by the data.<br>
